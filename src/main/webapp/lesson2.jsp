...
<html>
  <head>
    ...
    <title>DB通信_同期処理</title>
    <link
      href="https://fonts.googleapis.com/css?family=M+PLUS+Rounded+1c"
      rel="stylesheet"
    />
    <link rel="stylesheet" href="common/css/lesson2.css" />
  </head>
  <body>
    <h1>DB接続</h1>
    <main>
      <section class="req-section">
        <form id="form-section">
          <h2>リクエスト</h2>
          <div>
            <input type="text" placeholder="社員番号" name="employeeNum" />
          </div>
          <div>
    ...
    <script src="common/js/lesson2.js"></script>
  </body>
</html>
